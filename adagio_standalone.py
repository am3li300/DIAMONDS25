...
python3 main.py \
  --network '../data/networks/STRING_protein_links_parsed.tsv' \
  --genelist '../cross_validation/partitioning/RA_STRING_walktrap_clustering/3_RA_new_seeds_0.txt' \
  --out '../cross_validation/validation_rankings/RA_walktrap/3_RA_cross_validation_0.out'
"""
